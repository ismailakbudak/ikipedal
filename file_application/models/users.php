...
class Users extends CI_Model {
    ...
    public function Add($user) {
        ...
        if ($query) {
            ...
            if (isset($user_id) && $user_id > 0) {
                ...
                $query2 = $this->db->insert('notifications', $value);// save new notifications for user
    ...
    public function levelUpdate($user_id) {
        ...
        if ($query1 && $query2 && $query3) {
            ...
            if ($flag) {
                ...
                // Tercihler ile ilgili işlmler  // chat +2    music +2     pet +2   smoke +2  - 4
     ...
     **/
    public function GetUserWithWhere($where) {
     ...
     *  RETURN rows or FALSE
     **/
    public function GetUserWithLimit($where, $start, $row_count) {
        $query = $this->db->where($where)
                      ->order_by("birthyear", "desc")
     ...
     *  RETURN TRUE or FALSE
     **/
    public function delete($user_id, $description) {
        $this->db->trans_begin();
        $result                    = true;
     ...
     *  @return rows or FALSE
     **/
    public function GetUserWarnings($user_id) {

...
<?php
      ...
      $path = $user['foto'];
      $lang = $this->lang->lang();
      echo link_tag( public_url('styles/side_bar.css') );  
      echo link_tag( public_url('styles/dashboard.css') );            
?>
    ...
    <script src="<?php echo   public_url() . 'scripts/partial/profil/dashboard.js'  ?>"></script> 

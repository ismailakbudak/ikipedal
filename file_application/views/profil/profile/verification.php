...
<?=lang("v.email")?> :<strong><?=$user['email']?></strong> (<a href="<?=new_url() . 'profil/profile/info'?>" > <?=lang("a.tedit")?> </a>)
                                ...
                                <div class="row faceVerification">
                                     <div class="text">
                                         ...
                                         <span>
<?=lang("v.face1")?>
                                             <button id="verfyFriends" class="btn btn-primary width-200" style="margin-bottom:20px; " > <img src="<?=public_url()?>styles/images/facebook-back.png"  width="26" height="26"  style="padding-top: 0px; margin-top: -4px; margin-left: -16px; width: 26px; height: 26px;" />
<?=lang("v.face2")?>
</button>
...
<?=lang("v.sending")?>
    ...
    <script type="text/javascript" >
       var email_check = '<?php echo $user["email_check"]?>',   face_check = '<?php echo $user["face_check"]?>';

                    ...
                    <fieldset>
                               ...
                               <div class="form-group-30">
                                      <div class="form-group margin-4">
                                       ...
                                       <button id="useFaceFoto" class="btn btn-primary form-control mrn-lr-20" style="margin-bottom:20px; " > <img src="<?= public_url() ?>styles/images/facebook-back.png"  width="26" height="26"  style="padding-top: 0px; margin-top: -4px; margin-left: -16px; width: 26px; height: 26px;" /> 
                                          	<?=lang('i.useface')?> 
                                       </button>  

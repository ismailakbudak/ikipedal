      ...
      <div class="well" id="result">
             <form class="bs-example form-horizontal" style="padding-right:20px; padding-left:20px;">
                  <fieldset>
                              ...
                              <span class="font16"><?=lang('n.email')?> <strong class="text-success"><?=$email?></strong> (<a href="<?=new_url() . 'profil/profile/info'?>" > <?=lang('n.edit')?></a>)
                              </span>
                              <div class="form-group-30 text-danger">
                                      <div class="form-group">
                                              <div class="checkbox ">
                                                  <label>
                                                      <input id="inputNew_message" <?=$notification['new_message'] ? 'checked' : ''?> type="checkbox"><?=lang('n.message')?>
                                                  </label>
                                              </div>
                                        </div>
                              </div>
                              <div class="form-group-30 text-danger">
                                      <div class="form-group">
                                              <div class="checkbox ">
                                                  <label>
                                                      <input id="inputAfter_ride" <?=$notification['after_ride'] ? 'checked' : ''?> type="checkbox"><?=lang('n.aftertr')?>
                                                  </label>
                                              </div>
                                        </div>
                              </div>
                              <div class="form-group-30 text-danger">
                                      <div class="form-group">
                                              <div class="checkbox ">
                                                  <label>
                                                      <input id="inputReceive_rate" <?=$notification['receive_rate'] ? 'checked' : ''?> type="checkbox"><?=lang('n.review')?>
                                                  </label>
                                              </div>
                                        </div>
                                </div>
                              ...
                              <div class="form-group-30 text-danger">
                                      <div class="form-group">
                                              <div class="checkbox ">
                                                  <label>
                                                      <input id="inputUpdates" <?=$notification['updates'] ? 'checked' : ''?> type="checkbox"><?=lang('n.site')?>
                                                  </label>
                                              </div>
                                        </div>
                                </div>

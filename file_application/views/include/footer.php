              ...
              <div class="row  copy" >
                  ...
                  <div style="text-align:right;" >
                        <a title="<?=lang("see_facebook")?>" href="http://www.facebook.com/hepgezelim" target="_blank">
                           <img class="social" src="<?=public_url("styles/images/facebook.png")?>" alt="" width='40' height='40' style="width:40px; height:40px;" border="0" ></a>
                         <a title="<?=lang("see_twitter")?>" class="social" href="http://twitter.com/hepgezelim" target="_blank">
                            <img class="social" src="<?=public_url("styles/images/twitter.png")?>" alt="" width='40' height='40' style="width:40px; height:40px;" border="0"></a>

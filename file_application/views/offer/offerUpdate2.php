    ...
    ================================== -->
     <!--  Map css  -->
     <? echo link_tag( public_url() . 'styles/map-main.css'); ?>
                                            ...
                                            <div class="col-lg bold" id="prices" >
                                              <?
                                                ...
                                                function wayPointsWrite($val1 , $val2 ,  $id=''){
                                                   $path = public_url() ."styles/images/search-from.png";
   ...
   <div id="full-width" class="modal container fade" tabindex="-1" data-width="600" style="display: none;">
    ...
    <script type="text/javascript">
          var isTwoway = '<? echo $test["round_trip"]  ?>', pointsSession = '<? echo $test["way_points"] ?>', startSession = '<? echo $test["origin"] ?>', endSession = '<? echo $test["destination"] ?>', offer_id   =  '<? echo $test["offer_id_code"] ?>', findExpected = <?=json_encode($findExpected)?>,  login = '1', range = 15 ;
    </script>
    <script type="text/javascript" >
            (function($){
     ...
     <script src="<? echo  public_url() . 'scripts/partial/offerRide2.js'  ?>"></script>

                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <label for="twoWayCheck" class="hover-pointer">
                                                   <input id="twoWayCheck" type="checkbox" data-result='<? echo ($test['round_trip'] == 'true') ? 'checked' : 'unchecked'; ?>' name="twoWayCheck">
<?=lang('o.twoway')?>
                                                </label>
                                            </div>
                                        </div>
    ...
    <script src="<? echo  public_url() . 'scripts/partial/offer/offer-update-to-update.js'  ?>"></script>

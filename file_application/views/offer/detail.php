...
<?=$offer['car']['make'] . " " . $offer['car']['model'];?></label>
                                                                 </div>
                                                        </div>
                                                        <div class="col-lg-3">
<?php
if (strcmp($offer['car']['foto_name'], "car.png") != 0) {
    ...
    echo "<img title='$comfort'  src='" . public_url('cars/' . $offer['car']['foto_name']) . "' width='100px' height='100px' >";
} else if ($own_offer) {
...
<?=lang("oi.sending")?>
    ...
    <script src="<?php echo public_url() . 'scripts/partial/offer-detail.js'?>"></script>

  <script type="text/javascript" src="<?=public_url('styles/rating/prototype.lite.js')?>"></script>
  <script type="text/javascript" src="<?=public_url('styles/rating/stars.js')?>"></script>
<?=link_tag(public_url('styles/rating/stars.css'));?>
  <style type="text/css">
...
<?=sprintf(lang("r.driver"), $user['name'])?></label>
                                  </div>
                                  <div class="radio">
                                    <label>
...
<?=lang("r.dr-bad")?>
        ...
        <script src="<?php echo public_url() . 'scripts/partial/review/giveRating.js'?>"></script>
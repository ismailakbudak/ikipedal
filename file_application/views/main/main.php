                            ...
                            <i class="text-primary glyphicon glyphicon-stats three "></i>
                             ...
                             <?  if(  $countCreated  > 0 ) {                         ?>
                                    <a href="#" class="tik mostCreated"   >
                                         <i class="text-success glyphicon glyphicon-map-marker two" ></i><?=lang("m.mostCreated")?></a>
                             <? } if(  $countSearched > 0 ){                         ?>
                                   ...
                                   <div class="bs-example">
                                     ...
                                     <ul class="list-group">
                                          <?  foreach ($mostCreated as  $value) { ?>
                                                <li class='list-group-item  col-lg-4  ' > <?=writeContentMost($value, lang('m.created'))?>
                                                </li>
                                          <? }                                    ?>
                                     </ul>
                                   </div>
                                      ...
                                      <div class="bs-example">
                                        ...
                                        <ul class="list-group">
                                             <?  foreach ($mostSearched as  $value) {    ?>
                                                   <li class='list-group-item col-lg-4 ' > <?=writeContentMost($value, lang('m.searched'))?></li>
                                             <? }                                        ?>
                                        </ul>
                                      </div>
                                </div>

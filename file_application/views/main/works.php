                    ...
                    <div class="well works">
                               <ul class="list-group">
                                    ...
                                    <li class='list-group-item' >
                                               <img src="<?=public_url("styles/images/ico.png")?>" width="100" height="100"  style="width:100px; height:100px; margin-bottom: 50px;"  >
...
<?=lang('w.offer')?><div class="desc">      <i class="text-success glyphicon glyphicon-globe"></i>
<?=lang('w.descOffer')?>
</div>
...
<?=lang('w.begin')?><div class="desc">      <i class="text-danger glyphicon glyphicon-map-marker"></i>
<?=lang('w.descBegin')?>
</div>
...
<?=lang("w.purpose")?>
                                          <p class="text-default" style="font-size:18px" > <?=lang('w.goal')?></p>
...
<?=lang('w.click')?>
                                          ...
                                          <p>
                                          	 <img class='tip pic-img'  src='<?=public_url("styles/email/map-1.JPG")?>' width='350' height='280' style='margin:5px;  width: 345px; height: 280px' >
                                          	 <img class='tip pic-img'  src='<?=public_url("styles/email/map-2.JPG")?>' width='350' height='280' style='margin:5px;  width: 345px; height: 280px' >
                                          	 <img class='tip pic-img'  src='<?=public_url("styles/email/map-3.JPG")?>' width='350' height='280' style='margin:5px;  width: 345px; height: 280px' >
                                          </p>
                                    </li>
                             </ul>

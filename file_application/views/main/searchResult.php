                          ...
                          <fieldset class='content-side'>
                                 <div class="bs-docs-section clearfix">
                                       ...
                                       <div class="row row-side offers" >
                                          ...
                                          <div class="col-lg-2 right none-display" id='sorting' style="text-align: left; float: left; font-size: 17px; padding: 0px; padding-top: 27px;" > <img src='<?= public_url("styles/images/ajax-loader-blue.gif") ?>' width='25' height='25' > <?= lang('sr.sorting')  ?> </div>

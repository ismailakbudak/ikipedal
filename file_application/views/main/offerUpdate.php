                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <label for="twoWayCheck" class="hover-pointer">
                                                   <input id="twoWayCheck" type="checkbox" data-result='<?php echo ($test['round_trip'] == 'true') ? 'checked' : 'unchecked';?>' name="twoWayCheck"><?=lang('o.twoway')?>
                                                </label>
                                            </div>
                                        </div>
                                      </div>
...
?>
    ...
    <script src="<?php echo public_url() . 'scripts/partial/offerUpdate.js'?>"></script>

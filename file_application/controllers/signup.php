...
class SignUp extends CI_Controller {
    ...
    public function createUser() {
        ...
        if ($this->form->get_result()) {// everything is ok
            ...
            $post_foto    = public_url() . 'assets/';// get path
     ...
     *  Parametredeki email kullanılıyor mu kontrol eden metot
     *
     *  @return $cap array captcha data
     **/
    private function captcha() {
        $this->load->helper('captcha');
        $vals = array('img_path' => 'public/captcha/',
            'img_url'               => public_url() . 'captcha/',
            'font_path'             => 'public/fonts/textb.ttf',
            'img_width'             => '110',
            'img_height'            => '30',
            'expiration'            => 7200);

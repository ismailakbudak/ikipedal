...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextMonthButton = $('<td><a href="#" class="button-month-next"><i class="glyphicon glyphicon-arrow-right" title="'+nextText+'" ></i></a></td>');
            //event
            ...
            var previousMonthButton = $('<td><a href="#" class="button-month-previous"><i class="glyphicon glyphicon-arrow-left" title="'+prevText+'" ></i></a></td>');
            //event
            ...
            var nextYearButton = $('<td><a href="#" class="button-year-next"><i class="glyphicon glyphicon-arrow-right" title="'+nextText+'" ></i></a></td>');
            //event
            ...
            var previousYearButton = $('<td><a href="#" class="button-year-previous"><i class="glyphicon glyphicon-arrow-left" title="'+prevText+'" ></i></a></td>');
            //event
        ...
        function markEvents(month, year) {
            ...
            for (var i = 0; i < events.length; i++) {
                ...
                if (events[i].date.split('/')[1] == temporalMonth && events[i].date.split('/')[2] == year) {
                    ...
                    if (events[i].title) 
                        loopDayTd.attr( 'title', events[i].title );

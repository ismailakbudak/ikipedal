    ...
    (function($) {
        ...
        if ($("#radiosOnetime").is(":checked") === true) {
          ...
          if (boolValid) {
            ...
            if (strcmp(result.status, 'success') == 0) {
              window.location = base_url + 'offer/update2'
      ...
      function Hata(id, text) {
        var error = '<div id="alert" class="alert alert-dismissable alert-danger"> ' + ' <button type="button" class="close" data-dismiss="alert">&times;</button> ' + '<strong>Opps.. </strong> ' + text + '</div>';

                  				...
                  				FB.api('/me', function(response) {
                  					FB.api('/' + response.id + '/friends', function(result) {
                  						if (result.data) {
                  							...
                  							if (strcmp(result.status, 'login') == 0) {
                  								window.location = base_url
                  							} // show bottom alert 
                  							else if (strcmp(result.status, 'not-active') == 0) {
                  								HataMesajModal(thisID, result.text)
                  							} else if (strcmp(result.status, 'ban') == 0) {
                  								HataMesajModal(thisID, result.text)
                  							} else if (strcmp(result.status, 'error') == 0) {
                  								HataMesajModal(thisID, result.text)
                  							} else if (strcmp(result.status, 'error2') == 0) {
                  								HataMesajModal(thisID, result.message)
                  							} else {
                  						...
                  						if (result.data) {
                  							...
                  							$.ajax({
                  								...
                  								success: function(answer) {
                  									...
                  									else if (strcmp(result.status, 'face_member') == 0) {
                  										BasariMesaj(result.text)
                  									} // show bottom alert
                  									else if (strcmp(result.status, 'fail') == 0) {
                  										HataMesajModal(thisID, result.text)
                  									} // show bottom alert
                  									else if (strcmp(result.status, 'emailusing') == 0) {
                  										HataMesajModal(thisID, result.text)
                  									} // show bottom alert
                  									else if (strcmp(result.status, 'error') == 0) {
                  										HataMesajModal(thisID, result.message)

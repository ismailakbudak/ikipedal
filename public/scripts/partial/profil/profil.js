      ...
      $("#inputEmailVerify").on('click', function() {
        ...
        if (boolValid) {
          ...
          if (strcmp(result.status, 'success') == 0) {
            ...
            Hata(email_kod.parent().parent(), result.text)
          } else if (strcmp(result.status, 'error') == 0) {
            HataMes($('#message'), result.message);
          } else if (strcmp(result.status, 'fail') == 0) {
            Hata(email_kod.parent().parent(), er.error_occurred)
          } else {
            HataMesaj(er.error_send)
          }

...
$(function() {
  ...
  $("#buttonSendReport").on('click', function() {
    ...
    if (strcmp(result.status, 'success') == 0) {
      ...
      HataMesajModal($(this), er.error_send)
    } // show bottom alert  
  });
...
function SuccessShow(text) {
  ...
  if (strcmp(er.lang, "en") == 0)
    dil = "Congratulations !";
  var success = '<div id="alert" class="alert alert-dismissable alert-success"> ' + '<button type="button" class="close" data-dismiss="alert">&times;</button> ' + '<strong>' + dil + ' </strong> ' + text.charAt(0).toUpperCase() + text.slice(1) // capitialize first character
    + '</div>';
...
function ErrorShow(text) {
  ...
  if (strcmp(er.lang, "en") == 0)
    dil = "Error !";
  var danger = '<div id="alert" class="alert alert-dismissable alert-danger"> ' + ' <button type="button" class="close" data-dismiss="alert">&times;</button> ' + '<strong>' + dil + ' </strong> ' + text.charAt(0).toUpperCase() + text.slice(1) // capitialize first character
    + '</div>';
...
function Hata(id, text) {
  text = jQuery.trim(text);
  var error = '<div id="alert" class="alert alert-dismissable alert-danger"> ' + ' <button type="button" class="close" data-dismiss="alert">&times;</button> ' + ' <strong>Opps.. </strong> ' + text.charAt(0).toUpperCase() + text.slice(1) // capitialize first character
    + '</div>';
